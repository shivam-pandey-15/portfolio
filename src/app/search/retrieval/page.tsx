    ...
    return (
        <div className="min-h-screen p-8 md:p-12 max-w-4xl mx-auto space-y-8">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-primary">Retrieval</h1>
                <p className="text-xl text-muted-foreground">
                    Selecting the best few thousand candidates from billions of documents using BM25 and Vector Search.
                </p>
            </header>
