    ...
    return (
        <div className="min-h-screen p-8 md:p-12 max-w-4xl mx-auto space-y-8">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-primary">Ranking</h1>
                <p className="text-xl text-muted-foreground">
                    Refining top results with machine learning models. Feature engineering, LTR (Learning to Rank), and re-ranking.
                </p>
            </header>
