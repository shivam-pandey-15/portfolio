        ...
        <div className="space-y-24 animate-in fade-in duration-500 font-sans text-zinc-900 pb-20">
            ...
            <section className="space-y-8">
                ...
                <div className="bg-zinc-900 text-zinc-100 p-8 rounded-xl font-mono text-sm">
                    <div className="text-zinc-400 mb-4"># Bi-Encoder architecture</div>
                    <div className="space-y-2">
                        <div>Query: <span className="text-blue-400">&quot;cheap flights to NYC&quot;</span>    Document: <span className="text-green-400">&quot;Budget airline tickets New York&quot;</span></div>
                        <div className="text-zinc-500">        ↓                                ↓</div>
                        <div>   <span className="text-yellow-400">[Encoder A]</span>                      <span className="text-yellow-400">[Encoder B]</span></div>
                        <div className="text-zinc-500">        ↓                                ↓</div>
                        <div>   <span className="text-blue-300">query_vector [768]</span>          <span className="text-green-300">doc_vector [768]</span></div>
                        <div className="text-zinc-500">        ↓                                ↓</div>
                        <div>        └──── <span className="text-yellow-300">cosine_similarity(q, d) = 0.87</span> ────┘</div>
                    </div>
                </div>
            ...
            <section className="space-y-8">
                ...
                <div className="bg-zinc-900 text-zinc-100 p-8 rounded-xl font-mono text-sm">
                    <div className="text-zinc-400 mb-4"># Cross-Encoder architecture</div>
                    <div className="space-y-2">
                        <div>Input: <span className="text-blue-400">&quot;[CLS] cheap flights to NYC [SEP] Budget airline tickets New York [EOS]&quot;</span></div>
                        <div className="text-zinc-500">                              ↓</div>
                        <div>                    <span className="text-yellow-400">[Single Transformer]</span></div>
                        <div className="text-zinc-500">                    (12 layers, full cross-attention between ALL tokens)</div>
                        <div className="text-zinc-500">                              ↓</div>
                        <div>                    <span className="text-green-400">relevance_score = 0.92</span></div>
                    </div>
                </div>
