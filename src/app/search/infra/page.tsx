    ...
    return (
        <div className="min-h-screen p-8 md:p-12 max-w-4xl mx-auto space-y-8">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-primary">Infrastructure</h1>
                <p className="text-xl text-muted-foreground">
                    The distributed systems that power search. Sharding, replication, load balancing, and observability.
                </p>
            </header>
